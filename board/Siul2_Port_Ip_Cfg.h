...
#define UART9_RX_PIN            9u
#define UART9_RX_PORT           PTB_L_HALF
#define UART9_TX_PIN            10u
#define UART9_TX_PORT           PTB_L_HALF
#define UART8_TX_PIN            4u
#define UART8_TX_PORT           PTF_H_HALF
#define UART8_RX_PIN            5u
#define UART8_RX_PORT           PTF_H_HALF
